...
<div class="container">
    <div class="sign">
            ...
            <div class="row">
                    <span class="icon fltl"><svg width="21px" height="18px" viewBox="0 0 21 18" version="1.1"
                ...
                <input type="email" class="email" name="email" pattern="^[^\s@＠=]+[@|＠][^\.\s@＠]+(\.[^\.\s@＠]+)+$"
                       placeholder="Email">
            </div>
            <div class="row">
                    <span class="icon pass fltl"><svg width="21px" height="25px" viewBox="0 0 21 25" version="1.1"
                                                      xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <g transform="translate(0.000000, 20.000000)">
                                        <g transform="translate(0.000000, 20.000000)">
                                            <g transform="translate(0.000000, 119.000000)">
                                                <path d="M36,12.9375 C36,12.144 35.3452308,11.5 34.5384615,11.5 L18.4615385,11.5 C17.6547692,11.5 17,12.144 17,12.9375 L17,21.5625 C17,22.356 17.6547692,23 18.4615385,23 L34.5384615,23 C35.3452308,23 36,22.356 36,21.5625 L36,12.9375 L36,12.9375 Z M19.9230769,
                                                11.5 L19.9230769,6.46875 C19.9230769,2.8965625 22.8680769,0 26.5,0 C30.1319231,0 33.0769231,2.8965625 33.0769231,6.46875 L33.0769231,11.5 L19.9230769,11.5 Z M22.8461538,8.625 L22.8461538,6.46875 C22.8461538,4.4835625 24.4816154,2.875 26.5,2.875 C28.5183846,
                                                2.875 30.1538462,4.4835625 30.1538462,6.46875 L30.1538462,8.625"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
            ...
            <a href="#" class="button-api fltr billgate">
                    <span class="icon"><svg viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="#ffffff" fill-rule="evenodd">
                            <path d="M8.54124434,8.54124434 L0,8.54124434 L0,0 L8.54124434,0 L8.54124434,8.54124434 L8.54124434,8.54124434 Z"
                                  fill="#F1511B"></path>
                            <path d="M17.9717986,8.54124434 L9.43065611,8.54124434 L9.43065611,0 L17.9717986,0 L17.9717986,8.54124434 L17.9717986,8.54124434 Z"
                                  fill="#80CC28"></path>
                            <path d="M8.54104072,17.9751584 L0,17.9751584 L0,9.43391403 L8.54104072,9.43391403 L8.54104072,17.9751584 L8.54104072,17.9751584 Z"
                                  fill="#00ADEF"></path>
                            <path d="M17.9717986,17.9751584 L9.43065611,17.9751584 L9.43065611,9.43391403 L17.9717986,9.43391403 L17.9717986,17.9751584 L17.9717986,17.9751584 Z"
                                  fill="#FBBC09"></path>
                        </g></svg>
                    </span>
            </a>
        ...
        <span class="title-sign">
            ...
            <a href="http://127.0.0.1/wunderlist_php/signup.php">Create Account</a>
        </span>
    </div>
</div>
</body>
