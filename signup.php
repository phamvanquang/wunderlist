...
if(isset($_POST['register'])){
    ...
    if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['pass'])){
        ...
        $sql = "SELECT name, email, pass FROM account WHERE name=? AND email=? AND pass=?";
        ...
        if($query->rowCount() > 0){
            ...
            $sql = "INSERT INTO account(name, email, pass) VALUES(:name,:email,:pass)";
            $query = $conn->prepare($sql);
    ...
    <div class="container">
        <div class="sign">
            <form action="" method="POST" class="auth-form" autocomplete="off">
                <div class="row">
                    <span class="icon fltl"><svg width="20px" height="22px" viewBox="0 0 20 22" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-249.000000, -277.000000)" stroke-linecap="round" stroke="#2B88D9" stroke-linejoin="round">
                                <g transform="translate(231.000000, 238.000000)">
                                    <g transform="translate(0.000000, 20.000000)">
                                        <g transform="translate(0.000000, 20.000000)">
                                            <g>
                                                <path d="M25.2307692,13.3333333 C25.0036923,13.552 24.7212308,13.708 24.4110769,13.788 L21.3178462,14.5826667 C20.3195385,14.8386667 19.5510769,15.6093333 19.3281538,16.5813333 L19,18 C19,18 21.0755385,20 28,20 C34.9230769,20 37,18 37,18 L36.6870769,16.6586667 C36.4655385,15.7106667 35.7261538,14.9533333 34.7555385,14.6826667 L31.5653846,13.792 C31.2704615,13.7093333 31.0018462,13.5573333 30.7844615,13.348 L30.7692308,13.3333333 L25.2307692,13.3333333 Z M32.8461538,4.66666667 C32.8461538,2.08933333 30.6764615,0 28,0 C25.3235385,0 23.1538462,2.08933333 23.1538462,4.66666667 C23.1538462,7.948 25.1836923,12 28,12 C30.7664615,12 32.8461538,7.948 32.8461538,4.66666667 L32.8461538,4.66666667 Z M30.0769231,2.66666667 C29.422,3.29733333 28.8266154,4 27.3076923,4 C25.2321538,4 22.9032308,4.83733333 23.5346154,7.25866667"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                ...
                <div class="row">
                    <span class="icon fltl"><svg width="21px" height="18px" viewBox="0 0 21 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <input type="email" name="email" pattern="^[^\s@＠=]+[@|＠][^\.\s@＠]+(\.[^\.\s@＠]+)+$" placeholder="Email">
                </div>
                <div class="row">
                    <span class="icon pass fltl"><svg width="21px" height="25px" viewBox="0 0 21 25" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="row submit">
                    <input type="submit" name="register" value="Create free account" class="button">
                </div>
            </form>
            <div class="group-api">
                <a href="#" class="button-api fltl zuckerburg ">
                    <span class="icon facebook"><svg viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <a href="#" class="button-api fltl larrypage">
                    <span class="icon google"><svg viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#" class="button-api fltr billgate">
                    <span class="icon"><svg viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="title-sign">Have an account already?
                <a href="http://127.0.0.1/wunderlist_php/signin.php">Sign In</a>
            </span>
            <p class="title-sign small">
                By creating an account you agree to our <a href="http://www.wunderlist.com/terms-of-use" target="_blank">Terms of Use</a>
                and <a href="http://www.wunderlist.com/privacy-policy" target="_blank">Privacy Policy</a>.
            </p>
        </div>
        <ul class="list">
            <li>
                <span class="icon fltl"><svg width="100%" height="100%" viewBox="0 0 38 34" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="details">
                    <span class="hightlight">Get stuff done</span>
                    Whether you’re sharing a grocery list with a loved one or working on a project, Wunderlist makes it easy and fun to get things done.
                </div>
            </li>
            <li>
                <span class="icon fltl"><svg width="50px" height="37px" viewBox="0 0 50 37" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="details">
                    <span class="hightlight">Get reminded anytime</span>
                    Never forget a meeting, deadline or the milk again. Wunderlist’s easy to set reminders make sure you remember everything, big and small.
                </div>
            </li>
            <li>
                <span class="icon fltl"><svg width="44px" height="37px" viewBox="0 0 44 37" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="details">
                    <span class="hightlight">Keep your life in sync</span>
                    Available for iPhone, iPad, Android, Mac, Windows, Windows Phone, and the Web, Wunderlist instantly syncs all your lists to all your devices.
                </div>
            </li>
        </ul>
    </div>
